...
export const Settings: React.FC = () => {
    ...
    const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            console.error(error);
            addToast('Erro ao atualizar foto. Verifique se o bucket "avatars" existe e é público.', 'error');
        } finally {
    ...
    const handleExportData = async () => {
        try {
            ...
            saveAs(blob, `walletguard-backup-${new Date().toISOString().split('T')[0]}.json`);
    ...
    return (
        <div className="space-y-6 pb-20">
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Gerencie suas preferências e conta.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        {uploadingAvatar && <p className="text-xs text-gray-500">Enviando...</p>}
                    </div>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-4">
                        ...
                        />
                        <Button type="submit" isLoading={loadingProfile} className="w-full gap-2">
                            <Save size={18} />
                            Salvar Alterações
                        </Button>
                    </form>
                ...
                <Card>
                    <div className="flex items-center gap-2 mb-4">
                        {theme === 'dark' ? <Moon className="text-purple-500" size={20} /> : <Sun className="text-orange-500" size={20} />}
                ...
                <Card>
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-4">
                        ...
                        />
                        <Button type="submit" variant="outline" isLoading={loadingPassword} className="w-full">
                            Atualizar Senha
                        </Button>
                    </form>
                </Card>
