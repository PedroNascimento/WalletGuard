                            ...
                            <div className="p-6 h-48 flex flex-col justify-between relative z-10">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        {card.brand && <p className="text-white/70 text-sm">{card.brand}</p>}
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-xs text-white/70 uppercase tracking-wider mb-1">Limite</p>
                                            <p className="text-lg font-semibold">{formatCurrency(card.limit_amount)}</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-xs text-white/70 uppercase tracking-wider mb-1">Fechamento / Venc.</p>
                                            <div className="flex items-center gap-2 text-sm font-medium">
                                                <span className="flex items-center gap-1"><Calendar size={12} /> Dia {card.closing_day}</span>
                                                <span className="text-white/40">|</span>
                                                <span className="flex items-center gap-1">Dia {card.due_day}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
