...
export const DespesaForm: React.FC<DespesaFormProps> = ({ despesa, onSubmit, onCancel }) => {
    ...
    const validate = (): boolean => {
        ...
        if (formData.recorrente && !formData.frequencia_recorrencia) {
            newErrors.frequencia_recorrencia = 'Frequência é obrigatória para despesas recorrentes';
        }
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={(e) => setFormData({
                                ...
                                frequencia_recorrencia: e.target.checked ? 'mensal' : undefined
                            })}
                    ...
                    {formData.recorrente && (
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setFormData({
                                    ...formData,
                                    frequencia_recorrencia: e.target.value as 'semanal' | 'mensal' | 'anual'
                                })}
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white"
                            >
