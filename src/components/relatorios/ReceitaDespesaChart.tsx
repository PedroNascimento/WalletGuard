...
export const ReceitaDespesaChart: React.FC<Props> = ({ data }) => {
    if (!data || data.length === 0) {
        return (
            <Card className="h-[400px] flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 self-start px-6 pt-6">Evolução Receitas x Despesas</h3>
    ...
    return (
        <Card className="h-[400px] flex flex-col">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Evolução Receitas x Despesas</h3>
