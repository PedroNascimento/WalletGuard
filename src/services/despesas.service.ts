...
export const despesasService = {
  ...
  async update(id: string, despesa: Partial<DespesaFormData>) {
    ...
    if (despesa.descricao !== undefined)
      despesaParaBanco.description = despesa.descricao;
    ...
    if (despesa.categoria !== undefined)
      despesaParaBanco.category = despesa.categoria;
    if (despesa.tipo !== undefined) despesaParaBanco.type = despesa.tipo;
    if (despesa.recorrente !== undefined)
      despesaParaBanco.recurring = despesa.recorrente;
    if (despesa.frequencia_recorrencia !== undefined)
      despesaParaBanco.recurring_frequency = despesa.frequencia_recorrencia;
