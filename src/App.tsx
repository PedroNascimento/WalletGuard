...
const Receitas = React.lazy(() => import('./pages/receitas/Receitas').then(module => ({ default: module.Receitas })));
const Despesas = React.lazy(() => import('./pages/despesas/Despesas').then(module => ({ default: module.Despesas })));
const Cartoes = React.lazy(() => import('./pages/cartoes/Cartoes').then(module => ({ default: module.Cartoes })));
const GastosCartao = React.lazy(() => import('./pages/cartoes/GastosCartao').then(module => ({ default: module.GastosCartao })));
